        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li class="nav-item start  {{ $currentRoute == "admin-user-list" || $currentRoute == "admin-company-view" || $currentRoute == "admin-agency-view" || $currentRoute == "admin-agent-view" ||  $currentRoute == "admin-user-view" || $currentRoute == "admin-agent-list" ? "active": ""}}  {{ $currentRoute == "admin-agency-list" ? "active": ""}} {{ $currentRoute == "admin-company-list" ? "active": ""}} ">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    @if($currentRoute == "admin-user-list" || $currentRoute == "admin-company-view" || $currentRoute == "admin-agency-view" || $currentRoute == "admin-agent-view" || $currentRoute == "admin-user-view" || $currentRoute == "admin-agent-list" || $currentRoute == "admin-agency-list" || $currentRoute == "admin-company-list"  )
                            <span class="selected"></span>
                    @endif
                </a>
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item start {{ $currentRoute == "admin-agent-list" || $currentRoute == "admin-agent-view" ? "active": ""}}">
                    ...
                    <li class="nav-item start {{ $currentRoute == "admin-agency-list" || $currentRoute == "admin-agency-view" ? "active": ""}}">
                    ...
                    <li class="nav-item start {{ $currentRoute == "admin-company-list" || $currentRoute == "admin-company-view" ? "active": ""}}">
